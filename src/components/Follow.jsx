...
export const ButtonsFollowUnfollow = ({ id,onClick, followedUsername, innerText}) => {
  return (
    <nav id={id} className="blog-pagination" onClick={onClick}>
      <a className="btn  btn-outline-blue btn-lg" href="#">{innerText} {followedUsername}</a>
    </nav>
  );
};
