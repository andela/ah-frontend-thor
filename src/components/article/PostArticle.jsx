            ...
            <form onSubmit={this.onSubmit}>
              <div className="text-center">
                <div className="form-group shadow-textarea">
                  ...
                  {this.formInputHelper("textArea", "Article body...", "body", this.onChange, null, body, "form-control z-depth-1 no-border in-fontt", "20")}
              ...
              <TagsInput value={tags} onChange={this.onChang} />
