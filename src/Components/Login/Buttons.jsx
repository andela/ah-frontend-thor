		...
		<React.Fragment>
			<div>
				<div className="form-check">
					...
					<label className="btn btn-outline-info">Remember
							me</label><a className="btn btn-outline-info" href="">Forgot
							password?</a>
				</div>
			</div>

			<nav className="blog-pagination">
			<button className="btn btn-outline-info btn-rounded my-2 waves-effect z-depth-0"
