...
import ConnectedPostArticle from "../../src/components/article/PostArticle";
...
describe("<PostArticle />", () => {
  ...
  const provider = shallow(<ConnectedPostArticle store={store} match={{ params: { id: undefined } }} />);
  const PostArticleComponent = mount(<ConnectedPostArticle store={store} match={{ params: { id: undefined } }} />);
...
describe("<PostArticle />", () => {
  ...
  const preventDefault = jest.fn();
  const store = mockStore({ ...initialUserState });
  const provider = shallow(<ConnectedPostArticle store={store} match={{ params: { id: 2 } }} />);
  const PostArticleComponent = mount(<ConnectedPostArticle store={store} match={{ params: { id: 2 } }} />);
