...
import Follow, {RelatedArticles, ButtonsFollowUnfollow, mapStateToProps, mapDispatchToProps} from "../src/components/Follow";
...
describe("<ButtonsFollowUnfollow />", () => {
  test("renders the component", () => {
    const wrapper = shallow(<ButtonsFollowUnfollow id={"follow"} onClick={props.onClick} followedUsername={props.followedUsername} innerText={"Follow"}/>);
    expect(wrapper).toMatchSnapshot();
  });
});
...
describe("<ButtonsFollowUnfollow />", () => {
  test("renders the component", () => {
    const wrapper = shallow(<ButtonsFollowUnfollow id={"unfollow"} onClick={props.onClick} followedUsername={props.followedUsername} innerText={"Unfollow"}/>);
    expect(wrapper).toMatchSnapshot();
  });
});
...
describe("test the login container", () => {
  ...
  it("should mount the login component", () => {
    ...
    expect(wrapper.find("ButtonsFollowUnfollow").simulate("click", fakeEvent));
  ...
  describe("onClick()", () => {
    test("successfully calls the onSubmit handler", () => {
      const wrapper = shallow(
        <ButtonsFollowUnfollow id={"follow"} onClick={props.onClick} />
      );
...
describe("FollowButton />", () => {
  describe("onClick()", () => {
    test("successfully calls the onSubmit handler", () => {
      const wrapper = shallow(
        <ButtonsFollowUnfollow id={"unfollow"} onClick={props.onClick} />
      );
      wrapper.simulate("onClick");
